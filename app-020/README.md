...
- 每类设施按自身周期算下次应检日：灭火器 / 消火栓 30 天、指示灯 / 应急照明 90 天、安全出口 / 喷淋 180 天
- 按「楼栋 × 楼层 × 应检月份」分批：同一楼层的设施必在同一批，月检类季内逐月产生多批
- 派工日只排工作日（周末默认休，法定节假日可在页面配置）；每人每天设件数上限，
  超载整批顺延到下一工作日，批上写清顺延原因；整批超上限不可拆时整批派一人并置「超上限」警告
- 在楼层编辑器登记检查后，批次自动判定完成并从计划/派工清单划掉；未查完可一键挪到下一工作日的新批
- 计划表支持「按日期 / 按巡检员」两种视图；派工清单可一键复制（贴工作群）或下载 TXT
